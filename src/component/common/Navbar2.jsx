...
const Navbar2 = ({ toggleMenu, contactInfo = {} }) => {
        ...
        <div className="flex justify-between items-center px-4 md:px-8 lg:px-16 xl:px-34">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4 ml-4">
              {/* ===== IF NOT PRODUCTS ROUTE → SHOW INQUIRY NOW ===== */}
              {!isProductsRoute && (
                <button
                  onClick={() => navigate("/contact")}
                  className="px-5 py-2 rounded-lg font-medium transition-all hover:scale-105"
                  style={{
              ...
              {isProductsRoute && (
                <>
                  ...
                  {/* ----- If User Logged In → Show Cart + Dropdown ----- */}
                  {isAuthenticated && (
                    <>
                      {/* Shopping Cart */}
          ...
          <div className="flex items-center gap-4 md:hidden">
            ...
            {isProductsRoute && !isAuthenticated && (
              <button
                onClick={handleLogin}
                className="px-3 py-1 text-sm rounded-lg"
                style={{
