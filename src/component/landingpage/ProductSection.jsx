...
import { Sun, Wind, Droplets, ArrowRight, Zap, Shield, TrendingUp, Leaf } from "lucide-react";
...
const products = {
  ...
  wind: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1509390288600-9b9b1c3f7a8b?w=800",
      icon: Leaf,
    },
    {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  {/* Icon */}
                  <div className={`absolute top-4 right-4 p-3 rounded-xl ${theme.light}`}>
