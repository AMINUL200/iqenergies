...
const HandleBookingSurvey = () => {
  ...
  const markAsContacted = async (id) => {
    ...
    try {
      setUpdating(true);
      const response = await api.patch(`/admin/book-solar-surveys/${id}/contacted`);
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl border p-6" style={{ borderColor: colors.lightGray }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm" style={{ color: colors.mediumGray }}>Total Bookings</p>
                <h3 className="text-3xl font-bold mt-2" style={{ color: colors.primaryBlack }}>
                  {stats.total}
                </h3>
              </div>
          ...
          <div className="bg-white rounded-xl border p-6" style={{ borderColor: colors.lightGray }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm" style={{ color: colors.mediumGray }}>Contacted</p>
                <h3 className="text-3xl font-bold mt-2" style={{ color: colors.success }}>
                  {stats.contacted}
                </h3>
              </div>
          ...
          <div className="bg-white rounded-xl border p-6" style={{ borderColor: colors.lightGray }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm" style={{ color: colors.mediumGray }}>Pending Contact</p>
                <h3 className="text-3xl font-bold mt-2" style={{ color: colors.warning }}>
                  {stats.pending}
                </h3>
              </div>
              <div className="p-3 rounded-lg" style={{ backgroundColor: `${colors.warning}10` }}>
                <PhoneCall className="w-6 h-6" style={{ color: colors.warning }} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <Filter className="w-5 h-5" style={{ color: colors.mediumGray }} />
                <select
                  value={filterStatus}
        ...
        <div className="bg-white rounded-xl border overflow-hidden" style={{ borderColor: colors.lightGray }}>
          {filteredBookings.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: colors.primaryBlack }}>
                No bookings found
              </h3>
                ...
                <thead>
                  <tr style={{ backgroundColor: colors.softBackground }}>
                    <th className="py-4 px-6 text-left">
                      <span className="text-sm font-semibold" style={{ color: colors.primaryBlack }}>
                        Customer Details
                      </span>
                    </th>
                    <th className="py-4 px-6 text-left">
                    ...
                    >
                      <td className="py-4 px-6">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4" style={{ color: colors.mediumGray }} />
                            <span className="font-medium" style={{ color: colors.primaryBlack }}>
                              {booking.full_name}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Phone className="w-4 h-4" style={{ color: colors.mediumGray }} />
                            <a 
                          ...
                          <div className="flex items-center gap-2">
                            <Mail className="w-4 h-4" style={{ color: colors.mediumGray }} />
                            <a 
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          <Battery className="w-4 h-4" style={{ color: colors.warning }} />
                          <span className="font-medium" style={{ color: colors.primaryBlack }}>
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          <MapPin className="w-4 h-4" style={{ color: colors.danger }} />
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          <Calendar className="w-4 h-4" style={{ color: colors.mediumGray }} />
                          <span className="text-sm" style={{ color: colors.mediumGray }}>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold" style={{ color: colors.primaryBlack }}>
                    Booking Details
                  </h2>
                  <button
                  ...
                  >
                    <XCircle className="w-6 h-6" style={{ color: colors.mediumGray }} />
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  {/* Customer Info */}
                  <div>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2" style={{ color: colors.primaryBlack }}>
                      <Users className="w-5 h-5" />
                      Customer Information
                    </h3>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Full Name</p>
                        <p className="font-medium" style={{ color: colors.primaryBlack }}>
                          {selectedBooking.full_name}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Mobile Number</p>
                        <a 
                      ...
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Email Address</p>
                        <a 
                      ...
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Pincode</p>
                        <p className="font-medium" style={{ color: colors.primaryBlack }}>
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm" style={{ color: colors.mediumGray }}>Average Monthly Usage</p>
                          <p className="text-2xl font-bold" style={{ color: colors.primaryBlack }}>
                            {selectedBooking.average_monthly_usage} kWh
                          </p>
                        </div>
                        <div className="p-3 rounded-lg" style={{ backgroundColor: colors.info }}>
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Contact Status</p>
                        <div className="flex items-center gap-2 mt-1">
                          {selectedBooking.is_contacted ? (
                            ...
                            <>
                              <XCircle className="w-5 h-5" style={{ color: colors.warning }} />
                      ...
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Submitted On</p>
                        <p className="font-medium" style={{ color: colors.primaryBlack }}>
                      ...
                      <div>
                        <p className="text-sm" style={{ color: colors.mediumGray }}>Booking ID</p>
                        <p className="font-mono font-medium" style={{ color: colors.primaryBlack }}>
                          #{selectedBooking.id}
                        </p>
                      </div>
                    </div>
                  ...
                  {/* Actions */}
                  <div className="pt-6 border-t" style={{ borderColor: colors.lightGray }}>
